...
export default function KeysPage() {
  ...
  const sampleApiKey = "asdasfasfasgasweqeq22qeq2e23";
    ...
    <div className="relative min-h-screen">
      ...
      <div className="space-y-8 relative z-10 p-8">
        ...
        <Card className="relative rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition">
          <div className="absolute inset-0 bg-cover bg-center filter blur-sm" style={{ backgroundImage: "url('/bg1.jpg')" }} />
          ...
          <div className="relative p-6">
            ...
            <CardContent>
              ...
              <div className="mt-2 flex items-center gap-2 rounded-md bg-white/90 p-2">
                <code className="break-all font-mono text-sm text-white">{sampleApiKey}</code>
                <CopyButton value={sampleApiKey} />
              </div>
              <p className="mt-2 text-xs text-white">💡 Save this key securely. You won’t be able to see it again.</p>
            </CardContent>
          </div>
        </Card>
                ...
                <Table>
                  ...
                  <TableBody className="bg-white/90 divide-y divide-gray-200">
                    <TableRow className="hover:bg-gray-50 transition">
                      ...
                      <TableCell className="font-mono text-sm text-white">{sampleApiKey}</TableCell>
        ...
        <p className="text-center text-white">
          ...
          <code className="rounded bg-black-200 px-1 py-0.5 font-mono text-sm">x-api-key</code>{" "}
          header. See{" "}
